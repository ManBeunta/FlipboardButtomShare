package com.ramadhany.vodjo.flipboardbuttomsheet;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_custom_view:
                bottomSheetLayout.showWithSheetView(getLayoutInflater().inflate(R.layout.costum_view, bottomSheetLayout, false));
                break;
            ...
            case R.id.btn_intent:
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT, "Hay.... Assalamualaikum Warahmatullah");
